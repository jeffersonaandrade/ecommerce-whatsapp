...
export function BulkActionsBar({ selectedIds, onClear }: BulkActionsBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-hairline bg-canvas shadow-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isPending}
            onClick={() =>
              handleAction(() => bulkSetProductStatusAction(selectedIds, 'active'))
            }
